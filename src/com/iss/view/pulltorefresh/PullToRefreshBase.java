...
import com.iss.R;
import com.iss.view.pulltorefresh.internal.FlipLoadingLayout;
import com.iss.view.pulltorefresh.internal.LoadingLayout;
import com.iss.view.pulltorefresh.internal.RotateLoadingLayout;
import com.iss.view.pulltorefresh.internal.Utils;
import com.iss.view.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public final boolean onTouchEvent(MotionEvent event) {
		...
		switch (event.getAction()) {
			case MotionEvent.ACTION_MOVE: {
				//FIXME sj
				if(null != this.pullToRefreshTouchMoveListener){
					this.pullToRefreshTouchMoveListener.move((int)event.getY());
				}
			...
			case MotionEvent.ACTION_UP: {
				//FIXME sj
				if(null != this.pullToRefreshTouchMoveListener){
					this.pullToRefreshTouchMoveListener.up((int)event.getY());
				}
	...
	//===================================================================//
	//只用于VerticalViewPager,监听最后一个item的的移动
	//===================================================================//
	private PullToRefreshTouchMoveListener pullToRefreshTouchMoveListener;
	
	public void setPullToRefreshTouchMoveListener(PullToRefreshTouchMoveListener pullToRefreshTouchMoveListener){
		this.pullToRefreshTouchMoveListener = pullToRefreshTouchMoveListener;
	}
	
	public interface PullToRefreshTouchMoveListener{
		/**
		 * 移动
		 * @param moveY
		 */
