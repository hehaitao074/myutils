...
import com.iss.imageloader.cache.disc.DiscCacheAware;
import com.iss.imageloader.cache.disc.impl.UnlimitedDiscCache;
import com.iss.imageloader.cache.disc.naming.FileNameGenerator;
import com.iss.imageloader.cache.memory.MemoryCacheAware;
import com.iss.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.iss.imageloader.core.assist.ImageSize;
import com.iss.imageloader.core.assist.QueueProcessingType;
import com.iss.imageloader.core.decode.ImageDecoder;
import com.iss.imageloader.core.download.ImageDownloader;
import com.iss.imageloader.core.download.NetworkDeniedImageDownloader;
import com.iss.imageloader.core.download.SlowNetworkImageDownloader;
import com.iss.imageloader.core.process.BitmapProcessor;
import com.iss.imageloader.utils.L;
import com.iss.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * {@link com.iss.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.iss.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.iss.imageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.iss.imageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value - {@link com.iss.imageloader.cache.disc.impl.UnlimitedDiscCache
		 ...
		 * Consider {@link com.iss.imageloader.utils.L#disableLogging()} to disable ImageLoader logging completely (even error logs)
		 */
